...
echo "  stomarchy backup   - Backup your Omarchy customizations"
echo "  stomarchy restore  - Restore your customizations"
echo "  stomarchy sync     - Sync with latest Omarchy release"
